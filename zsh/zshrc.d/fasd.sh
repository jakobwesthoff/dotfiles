alias j='colorize "<purple>DEPRECATED: you should use the *z* command</purple>"; fasd_cd -d'
alias jj='colorize "<purple>DEPRECATED: you should use the *zz* command</purple>"; fasd_cd -d -i'

# Generated by: .fasd/fasd --init posix-alias zsh-hook zsh-ccomp zsh-wcomp zsh-ccomp-install zsh-wcomp-install
# With minimal changes (marked)
alias a='fasd -a'
alias s='fasd -si'
alias sd='fasd -sid'
alias sf='fasd -sif'
